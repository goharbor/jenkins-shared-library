...
usage(){
  ...
  echo "  -b, --case-branch             The branch/tag of the test case repository, default: release-2.4.0"
  ...
  echo "      --image-registry          The registry where stores the test images, default: harbor-repo.vmware.com"
